...
class RisetBluettothPrintPage extends StatefulWidget {
  @override
  State<RisetBluettothPrintPage> createState() => _RisetBluettothPrintState();
}

class _RisetBluettothPrintState extends State<RisetBluettothPrintPage> {
